...
Actually, not every tools. For now, my app has three functionality.
It has a pomodoro timer that can help you stay focus. (Pomodoro is a technique to stay focused by setting a timer to work on your tasks)
It has an assignment planner. 
Lastly, a statistic functionality.